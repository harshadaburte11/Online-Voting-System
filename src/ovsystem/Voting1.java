...
public class Voting1 extends JFrame 
{
    ...
    public Voting1() 
	{
        ...
        JLabel lh = new JLabel(" Voting For PM ");
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BJP' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Shiv-Sena' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Congress' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='AAP' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BSP' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='CPM' AND position='PM'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='SJP' AND position='PM'");
        	while(rs.next())
        	{
	   ...
	   b1= new JButton(" Vote ");
		...
		b1.addActionListener(new ActionListener()
		{
            public void actionPerformed(ActionEvent e)
			{
			    ...
			    {    
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,bjp)values ('"+uId+"','"+cnt+"')");
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,shivsena)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,Congress)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,aap)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,bsp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,cpm)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vpm(vid,sjp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		...
		b2.addActionListener(new ActionListener()
		{
			...
			{
            	Voting2 v2=new Voting2();         //code for next page
            	//v2.vid2=vid2;
            	v2.setVisible(true);
         		setVisible(false);
         		v2.setSize(800,800);
         		v2.setLocation(250,30);
			}
		});
