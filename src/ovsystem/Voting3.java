...
public class Voting3 extends JFrame 
{
	...
	private JRadioButton r1,r2,r3,r4,r5,r6,r7;
     ...
     public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                      Voting3 frame = new Voting3();                   
	                    frame.setVisible(true);
	                    frame.setTitle(" Voting Form ");
    ...
    public Voting3() 
	{
        ...
        JLabel lh = new JLabel(" Voting For Guardian Minister ");
        lh.setFont(new Font("Times New Roman", Font.BOLD, 42));
        lh.setBounds(180, 35, 575, 50);
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BJP' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Shiv-Sena' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Congress' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='AAP' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BSP' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='CPM' AND position='Guardian Minister'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='SJP' AND position='Guardian Minister'");
        	while(rs.next())
        	{
	   ...
	   b1= new JButton(" Vote ");
		...
		b1.addActionListener(new ActionListener()
		{
            public void actionPerformed(ActionEvent e)
			{
			    ...
			    {    
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,bjp)values ('"+uId+"','"+cnt+"')");
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,shivsena)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,congress)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,aap)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,bsp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,cpm)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vgm(vid,sjp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		...
		b2.addActionListener(new ActionListener()
		{
			...
			{
            	Voting4 v4=new Voting4();         //code for next page
              //v4.vid4=vid4;
            	v4.setVisible(true);
         		setVisible(false);
         		v4.setSize(800,800);
         		v4.setLocation(250,30);
			}
		});
