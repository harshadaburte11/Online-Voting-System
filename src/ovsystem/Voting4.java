...
public class Voting4 extends JFrame 
{
    ...
    public Voting4() 
	{
        ...
        JLabel lh = new JLabel(" Voting For Education-Mantri ");
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BJP' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='shivsena' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Congress' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='AAP' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BSP' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='CPM' AND position='Minister of Education'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='SJP' AND position='Minister of Education'");
        	while(rs.next())
        	{
		...
		b1.addActionListener(new ActionListener()
		{
            public void actionPerformed(ActionEvent e)
			{
			    ...
			    {    
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,bjp)values ('"+uId+"','"+cnt+"')");
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,shiv-sena)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,congress)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,aap)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,bsp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,cpm)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vem(vid,sjp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
