...
public class Voting2 extends JFrame 
{
    ...
    public Voting2() 
	{
        ...
        JLabel lh = new JLabel(" Voting For Aarogya-Mantri ");
        lh.setFont(new Font("Times New Roman", Font.BOLD, 42));
        lh.setBounds(180, 35, 550, 50);
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BJP' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Shiv-Sena' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='Congress' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='AAp' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='BSP' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='CPM' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
        ...
        try
        {
        	ResultSet rs=st.executeQuery("select name from candidatedb where party='SJP' AND position='Arogya Mantri'");
        	while(rs.next())
        	{
	   ...
	   b1= new JButton(" Vote ");
		...
		b1.addActionListener(new ActionListener()
		{
            public void actionPerformed(ActionEvent e)
			{
			    ...
			    {    
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,bjp)values ('"+uId+"','"+cnt+"')");
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,shivsena)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,congress)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,aap)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,bsp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,cpm)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			          /*MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		    	...
		    	{  
			    	...
			    	{
			    	 int cnt=1;
			          int i=st.executeUpdate("insert into vam(vid,sjp)values ('"+uId+"','"+cnt+"')");
			          JOptionPane.showMessageDialog(b1,"Thanks for Voting");
			         /* MainPage pg=new MainPage();
		         		pg.setVisible(true);
		         		setVisible(false);
		...
		b2.addActionListener(new ActionListener()
		{
			...
			{
            	Voting3 v3=new Voting3();         //code for next page
            	//v3.vid3=vid3;
            	v3.setVisible(true);
         		setVisible(false);
         		v3.setSize(800,800);
         		v3.setLocation(250,30);
			}
		});
